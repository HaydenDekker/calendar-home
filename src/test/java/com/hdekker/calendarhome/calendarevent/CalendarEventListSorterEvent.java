...
public class CalendarEventListSorterEvent {
	...
	public void sortsByDate() {
		...
		CalendarEvent ce1 = new CalendarEvent("Yippee", "Yes", LocalDateTime.now(), LocalDateTime.now().plusHours(1));
		CalendarEvent ce2 = new CalendarEvent("Yippee", "Yes", LocalDateTime.now().minusHours(5), LocalDateTime.now().minusHours(4));
